...
(function () {
    ...
    DateRangePicker.prototype = {
        ...
        renderTimePicker: function(side) {
            ...
            html = '<select class="hourselect form-select form-select-sm choices">';
            ...
            html += ': <select class="minuteselect form-select form-select-sm choices">';
            ...
            if (this.timePickerSeconds) {
                html += ': <select class="secondselect form-select form-select-sm choices">';
            ...
            if (!this.timePicker24Hour) {
                html += '<select class="ampmselect form-select form-select-sm choices">';
